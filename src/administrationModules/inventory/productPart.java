...
public class productPart {
    ...
    public productPart(int partsID, String partsName, int partsLevel, double partsCost, int partMax, int partMin, String companyNameOrMachineID, boolean inHouse, int associatedPartID) {
